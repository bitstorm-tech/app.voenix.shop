...
export function convertCostCalculationToCents(costCalc: any): any {
  ...
  return {
    ...
    // Sales section
    salesMarginNet: eurosToCents(costCalc.salesMarginNet || costCalc.marginNet || 0),
    salesMarginTax: eurosToCents(costCalc.salesMarginTax || costCalc.marginTax || 0),
    salesMarginGross: eurosToCents(costCalc.salesMarginGross || costCalc.marginGross || 0),
    ...
    salesMarginPercent: costCalc.salesMarginPercent || costCalc.marginPercent,
...
export function convertCostCalculationToEuros(costCalc: any): any {
  ...
  return {
    ...
    // Sales section - handle both old (margin*) and new (salesMargin*) field names
    marginNet: centsToEuros(costCalc.salesMarginNet || 0),
    marginTax: centsToEuros(costCalc.salesMarginTax || 0),
    marginGross: centsToEuros(costCalc.salesMarginGross || 0),
    marginPercent: costCalc.salesMarginPercent,
