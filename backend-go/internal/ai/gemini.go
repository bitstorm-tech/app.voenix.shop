...
func (g *GeminiGenerator) Edit(ctx context.Context, image []byte, prompt string, opts Options) ([][]byte, error) {
    ...
    if opts.MaxOutputTokens != nil {
        body["generationConfig"].(map[string]any)["maxOutputTokens"] = *opts.MaxOutputTokens
    } else if g.DefaultMaxTokens != nil {
        body["generationConfig"].(map[string]any)["maxOutputTokens"] = *g.DefaultMaxTokens
    }
    if opts.Temperature != nil {
        body["generationConfig"].(map[string]any)["temperature"] = *opts.Temperature
    } else if g.DefaultTemperature != nil {
        body["generationConfig"].(map[string]any)["temperature"] = *g.DefaultTemperature
    }
