...
@Entity
@Table(name = "article_pillow_variants")
data class ArticlePillowVariant(
    @Id
    ...
    fun toDto() =
        ArticlePillowVariantDto(
            id = requireNotNull(this.id) { "ArticlePillowVariant ID cannot be null when converting to DTO" },
