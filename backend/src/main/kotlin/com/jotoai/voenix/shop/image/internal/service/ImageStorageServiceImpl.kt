...
class ImageStorageServiceImpl(
    ...
    override fun storeFile(file: MultipartFile, imageType: ImageType): String {
    ...
    override fun storeFile(bytes: ByteArray, originalFilename: String, imageType: ImageType): String {
        throw UnsupportedOperationException("Not yet implemented")
    }

    override fun loadFileAsResource(filename: String, imageType: ImageType): Resource {
        throw UnsupportedOperationException("Use ImageAccessService instead")
    }

    override fun generateImageUrl(filename: String, imageType: ImageType): String {
        return storagePathService.generateImageUrl(filename, imageType)
    }
