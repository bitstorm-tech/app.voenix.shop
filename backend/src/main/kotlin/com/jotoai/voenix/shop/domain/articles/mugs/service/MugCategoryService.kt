...
import com.jotoai.voenix.shop.domain.articles.mugs.dto.CreateMugCategoryRequest
import com.jotoai.voenix.shop.domain.articles.mugs.dto.MugCategoryDto
import com.jotoai.voenix.shop.domain.articles.mugs.dto.UpdateMugCategoryRequest
...
class MugCategoryService(
    ...
    fun getAllCategories(): List<MugCategoryDto> = mugCategoryRepository.findAll().map { it.toDto() }
    ...
    fun updateCategory(
        id: Long,
        request: UpdateMugCategoryRequest,
    ): MugCategoryDto {
        val category =
            mugCategoryRepository
                .findById(id)
