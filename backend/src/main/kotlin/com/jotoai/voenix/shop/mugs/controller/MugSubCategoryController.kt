...
class MugSubCategoryController(
    ...
    @GetMapping
    fun getAllSubCategories(): ResponseEntity<List<MugSubCategoryDto>> = 
        ResponseEntity.ok(mugSubCategoryService.getAllSubCategories())
    
    @GetMapping("/{id}")
    fun getSubCategoryById(@PathVariable id: Long): ResponseEntity<MugSubCategoryDto> = 
        ResponseEntity.ok(mugSubCategoryService.getSubCategoryById(id))
    
    @GetMapping("/category/{categoryId}")
    fun getSubCategoriesByCategoryId(@PathVariable categoryId: Long): ResponseEntity<List<MugSubCategoryDto>> = 
        ResponseEntity.ok(mugSubCategoryService.getSubCategoriesByCategoryId(categoryId))
    ...
    @PostMapping
    fun createSubCategory(@Valid @RequestBody request: CreateMugSubCategoryRequest): ResponseEntity<MugSubCategoryDto> {
    ...
    fun updateSubCategory(
        ...
        ResponseEntity.ok(mugSubCategoryService.updateSubCategory(id, request))
