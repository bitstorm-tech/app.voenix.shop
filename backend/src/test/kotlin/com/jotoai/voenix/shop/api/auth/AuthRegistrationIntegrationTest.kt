...
@Sql(
    statements = [
        "CREATE TABLE IF NOT EXISTS SPRING_SESSION (PRIMARY_ID CHAR(36) NOT NULL, " +
            "SESSION_ID CHAR(36) NOT NULL, CREATION_TIME BIGINT NOT NULL, " +
            "LAST_ACCESS_TIME BIGINT NOT NULL, MAX_INACTIVE_INTERVAL INT NOT NULL, " +
            "EXPIRY_TIME BIGINT NOT NULL, PRINCIPAL_NAME VARCHAR(100), " +
            "CONSTRAINT SPRING_SESSION_PK PRIMARY KEY (PRIMARY_ID))",
        "CREATE TABLE IF NOT EXISTS SPRING_SESSION_ATTRIBUTES (SESSION_PRIMARY_ID CHAR(36) NOT NULL, " +
            "ATTRIBUTE_NAME VARCHAR(200) NOT NULL, ATTRIBUTE_BYTES LONGVARBINARY NOT NULL, " +
        ...
        "INSERT INTO roles (name, description, created_at, updated_at) " +
            "VALUES ('USER', 'Regular user role', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)",
    ],
)
